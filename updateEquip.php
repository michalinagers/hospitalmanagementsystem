...
<div class="menu">
    ...
    <div class="updates">
        <form method="post" action="updateEquip.php?uid=<?php echo $_GET['uid']; ?>">
            ...
            <input class="form-control updateBox" type="text" name="availability"
                   value="<?php echo !empty($updateEquip) ? $updateEquip[0][4] : ''; ?>"><br><br>

            <input type="submit" class="submitEquip" name="submit" value="Update"></input>
        </form>
        <button type="button" class="backEquip" onclick="location.href='hospitalEquip.php'">Back</button>
    </div>
</div>
